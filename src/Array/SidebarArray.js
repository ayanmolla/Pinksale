...
const SidebarArray = (t) => [
  ...
  { id: "buy-crypto", label: t("buy-crypto"), link: "/buy-crypto", icon: HiCash, hasChildren: false, children: [] },
  { id: "anti-bot", label: t("anti-bot"), link: "/anti-bot", icon: LuBot, hasChildren: false, children: [] },
  { id: "multi-sender", label: t("multi-sender"), link: "/multi-sender", icon: PiPaperPlaneRight, hasChildren: false, children: [] },
